...
public class BetterToolsTags {
    public static class Blocks {
        ...
        public static final TagKey<Block> PROSPECTING_PICK_MINEABLE = createTag("mineable/prospecting_pickaxe");
        ...
        public static final TagKey<Block> PROSPECTING_PICK_VEIN_MINES = createTag("prospecting_pickaxe_vein_mines");

        private static TagKey<Block> createTag(String name) {
            return TagKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(BetterToolsFabric.MOD_ID, name));
        }
    }
    ...
    public static class Items {
        ...
        public static final TagKey<Item> PROSPECTING_PICKS = createTag("prospecting_pickaxes");
        ...
        private static TagKey<Item> createTag(String name) {
            return TagKey.create(Registries.ITEM, ResourceLocation.fromNamespaceAndPath(BetterToolsFabric.MOD_ID, name));
        }
    }
}
