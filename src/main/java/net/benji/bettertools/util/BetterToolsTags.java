...
public class BetterToolsTags {
    public static class Blocks {
        ...
        private static TagKey<Block> createTag(String name) {
            return TagKey.create(Registries.BLOCK, new ResourceLocation(BetterToolsFabric.MOD_ID, name));
        }
    }
    ...
    public static class Items {
        ...
        private static TagKey<Item> createTag(String name) {
            return TagKey.create(Registries.ITEM, new ResourceLocation(BetterToolsFabric.MOD_ID, name));
        }
    }
}
