    ...
    protected @NotNull RecipeProvider createRecipeProvider(HolderLookup.Provider registryLookup, RecipeOutput exporter) {
        return new RecipeProvider(registryLookup, exporter) {
            ...
            public void buildRecipes() {
                ...
                generatePaxelRecipe(exporter, BetterToolsItems.COPPER_PICKAXE, BetterToolsItems.COPPER_AXE, BetterToolsItems.COPPER_SHOVEL, BetterToolsItems.COPPER_PAXEL);
                ...
                generateSwordRecipe(exporter, Items.COPPER_INGOT, BetterToolsItems.COPPER_SWORD);
                generateShovelRecipe(exporter, Items.COPPER_INGOT, BetterToolsItems.COPPER_SHOVEL);
                generatePickaxeRecipe(exporter, Items.COPPER_INGOT, BetterToolsItems.COPPER_PICKAXE);
                generateAxeRecipe(exporter, Items.COPPER_INGOT, BetterToolsItems.COPPER_AXE);
                generateHoeRecipe(exporter, Items.COPPER_INGOT, BetterToolsItems.COPPER_HOE);
