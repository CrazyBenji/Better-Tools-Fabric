...
public class PaxelRecipe extends CustomRecipe {
    ...
    public static class PaxelRecipeSerializer implements RecipeSerializer<PaxelRecipe> {
        ...
        @Override
        public @NotNull PaxelRecipe fromJson(ResourceLocation resourceLocation, JsonObject jsonObject) {
            ...
            Item resultItem = BuiltInRegistries.ITEM.getOptional(new ResourceLocation(recipeJson.result)).orElseThrow();
        ...
        @Override
        public @NotNull PaxelRecipe fromNetwork(ResourceLocation resourceLocation, FriendlyByteBuf friendlyByteBuf) {
        ...
        @Override
        public void toNetwork(FriendlyByteBuf friendlyByteBuf, PaxelRecipe recipe) {
